...
public class Client2Run {
    ...
    private void connect() {
        ...
        new Thread(() -> {
            // call controller
            String result = Client2Run.getSocketHandler().connect(ip, port);
    ...
    private static Client2Run instance;

    public static Client2Run getInstance() {
        if (instance == null) {
            instance = new Client2Run();
        }
        return instance;
    }
